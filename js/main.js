...
function atualiza() {
    $(this).css('background-color', '#31a252');
    valor = $('#valor').text();
    valor = valor.replace(',','.');
    setTimeout(function(){
        $('.col').css('background-color', '#31a252');
        $('.numeros').css('background-color', '#6ecf42');
    },100);
    $('.col').hover(function(){
        $(this).css('background-color', '#23773c');
    }, function(){
        $(this).css('background-color', '#31a252');
    });
    $('.numeros').hover(function(){
        $(this).css('background-color', '#1a582d');
    }, function(){
        $(this).css('background-color', '#6ecf42');
    });
}
...
$(document).on('click', '#memoria', function(){
    ...
    document.getElementById('mem').style.borderBottom = "3px solid #31a252";
...
$(document).on('click', '#historico', function() {
    ...
    while(historicoLocal.includes(','))
        historicoLocal = historicoLocal.replace(',','<br>');
    $('#div-historico').html(historicoLocal);
    $('#his').css('borderBottom', '3px solid #31a252');
